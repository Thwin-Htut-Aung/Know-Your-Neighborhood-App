...
import './App.css';
import { SearchStore } from '../user/store/SearchStore';
import { Stores } from '../user/store/Stores';
      ...
      <div className="app">
        ...
        <div className="app-body">
          <Switch>
            ...
            <PrivateRoute path="/search/:searchkey?" authenticated={this.state.authenticated} currentUser={this.state.currentUser}
